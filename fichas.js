...
const fichas = [
    ...
    { nombre: "刘荇羽", pinyin: "Liú Xíngyǔ", seguidores: 0.562, likes: 7.2, ratio: 12.80, origen: "Chongqing, China", provincia: "重庆市", coord: [106.55, 29.56], archivo: "muralista.jpg", nicho: "Murales en relieve" }  { nombre: "潇洒小柴", pinyin: "Xiāo Sǎ Xiǎo Chái", seguidores: 0.469, likes: 6.6, ratio: 14.07, origen: "Hunan", provincia: "湖南省", coord: [112.94, 28.23], archivo: "pesakawai.jpg", nicho: "Fitness kawaii" },
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('✅ Iniciando con', fichas.length, 'creadoras');
    actualizarPagina();
    setTimeout(() => {
